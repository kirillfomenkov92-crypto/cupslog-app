    ...
    <div className="py-20 flex flex-col items-center gap-4 text-center">
      <div className="w-14 h-14 rounded-2xl bg-chip flex items-center justify-center">
        ...
        >
          ...
          />
          <path
            d="M4 22h16M12 17v5M8 13v4M16 13v4M6 9h12v4a6 6 0 0 1-12 0V9Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
      ...
      <div>
        ...
        <p className="text-dim text-sm">Создайте первый турнир в админ-панели</p>
      </div>
      <Link
        href="/admin"
...
export default async function TournamentsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      <h1 className="text-3xl font-bold tracking-tight text-prose mb-8">
        Турниры
      </h1>
